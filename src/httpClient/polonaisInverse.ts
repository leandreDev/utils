...
export function polonaisInverse(req: string = '*', entity: { castQueryParam(path: string, value: any): any }): Promise<any[]> {
    ...
    .then(() => {
      let operators = {
         ...
         */
          if (stackArr.length < 2) {
            ...
            let param2: any = stackArr.pop();
            let param1: any = stackArr.pop();
            if (param1.$and) {
              let obj = {};
        ...
        "$not": function (stackArr: any[]) {
          ...
          */
          if (stackArr.length < 1) {
            ...
            let expression: Object = stackArr.pop();
        ...
        "$nor": function (stackArr: any[]) {
          ...
          */
          if (stackArr.length < 2) {
            ...
            let expressions: any[] = stackArr.splice(0, stackArr.length);
            let obj: any = { $nor: expressions };
            stackArr.push(obj);
          }
          ;
        },
        "$exists": function (stackArr: any[]) {
          ...
          */
          if (stackArr.length < 2) {
            ...
            let exists: boolean = (stackArr.pop() === 'true');
            let field: string = stackArr.pop();
            let obj: any = {};
        ...
        "$mod": function (stackArr: any[]) {
          ...
          */
          if (stackArr.length < 3) {
            ...
            let remainder: number = +stackArr.pop();
            let divisor: number = +stackArr.pop();
            let field: string = stackArr.pop();
            let obj: any = {};
        ...
        "$text": function (stackArr: any[]) {
          if (stackArr.length < 4) {
            ...
            let diacriticSensitive: boolean = (stackArr.pop() === 'true');
            let caseSensitive: boolean = (stackArr.pop() === 'true');
            let language: string = stackArr.pop();
            let search: string = stackArr.pop();
            let obj: any = {};
            obj.$text = {
              $search: search,
              $language: language,
        ...
        "$size": function (stackArr: any[]) {
          ...
          */
          if (stackArr.length < 2) {
            ...
            let size: Number = new Number(stackArr.pop());
            let field: string = stackArr.pop();
            let obj: any = {};
        ...
        "$pop": function (stackArr: any[]) {
          if (stackArr.length < 1) {
            ...
            let param1: string = stackArr.pop();
            let obj: any = { name: "$pop" };
            obj.value = param1;
            stackArr.push(obj);
          }
          ;
        ...
        "$limit": function (stackArr: any[]) {
          if (stackArr.length < 1) {
            ...
            let param1: number = new Number(stackArr.pop()).valueOf();
            let obj: any = { name: "$limit" };
            obj.value = param1;
            stackArr.push(obj);
          }
          ;
        ...
        "$sort": function (stackArr: any[]) {
          if (stackArr.length < 1) {
            ...
            let param1: string = stackArr.pop();
            let param2: string = stackArr.pop();
            let obj: any = { name: "$sort" };
            let sort = {};
      ...
      while (queryArr.length) {
        ...
        if (operators[word]) {
          ...
          if (word.length === 24 && /^[a-h0-9]{24}$/i.test(word) && ObjectId.isValid(word)) {
